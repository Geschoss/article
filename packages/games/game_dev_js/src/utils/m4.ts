function init() {
   ...
   * @memberOf module:webgl-3d-math
   */
  function xRotate(m: Float32Array, angleInRadians: number, dst = new MatType(16)) {
    // this is the optimized version of
   ...
   * @memberOf module:webgl-3d-math
   */
  function yRotate(m: Float32Array, angleInRadians: number, dst = new MatType(16)) {
    // this is the optimized version of
   ...
   * @memberOf module:webgl-3d-math
   */
  function zRotate(m: Float32Array, angleInRadians: number, dst = new MatType(16)) {
    // This is the optimized version of
   ...
   * @memberOf module:webgl-3d-math
   */
  function scale(m: Float32Array, sx: number, sy: number, sz: number, dst = new MatType(16)) {
    // This is the optimized version of
