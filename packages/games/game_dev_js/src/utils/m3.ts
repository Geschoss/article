function init() {
   ...
   * @memberOf module:webgl-2d-math
   */
  function multiply(a: Float32Array, b: Float32Array, dst = new MatType(9)) {
    var a00 = a[0 * 3 + 0]
    var a01 = a[0 * 3 + 1]
    var a02 = a[0 * 3 + 2]
    var a10 = a[1 * 3 + 0]
   ...
   */
  function identity(dst = new MatType(9)) {
    dst[0] = 1
    dst[1] = 0
    dst[2] = 0
    dst[3] = 0
   ...
   * @memberOf module:webgl-2d-math
   */
  function projection(width: number, height: number, dst = new MatType(9)) {
   ...
   * @memberOf module:webgl-2d-math
   */
  function translation(tx: number, ty: number, dst = new MatType(9)) {
    dst[0] = 1
    dst[1] = 0
    dst[2] = 0
    dst[3] = 0
   ...
   * @memberOf module:webgl-2d-math
   */
  function translate(m: Float32Array, tx: number, ty: number, dst = new MatType(9)) {
   ...
   * @memberOf module:webgl-2d-math
   */
  function rotation(angleInRadians: number, dst = new MatType(9)) {
   ...
   * @memberOf module:webgl-2d-math
   */
  function rotate(m: Float32Array, angleInRadians: number, dst = new MatType(9)) {
   ...
   * @memberOf module:webgl-2d-math
   */
  function scaling(sx: number, sy: number, dst = new MatType(9)) {
    dst[0] = sx
    dst[1] = 0
    dst[2] = 0
    dst[3] = 0
   ...
   * @memberOf module:webgl-2d-math
   */
  function scale(m: Float32Array, sx: number, sy: number, dst = new MatType(9)) {
